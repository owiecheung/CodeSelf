...
public class AdminServiceHolder implements AdminService {
  ...
  @Override
  public Channel getChannelBySourceAppAndTranType(String sourceApp, String tranType) throws ApiException {

    HashMap<String, String> hMap = new HashMap<>();
    hMap.put("sourceApp", sourceApp);
    hMap.put("tranType", tranType);

    return channelApi.invoke(baseUrl, serviceVers, serviceUrl, hMap, Channel.class);
  }
