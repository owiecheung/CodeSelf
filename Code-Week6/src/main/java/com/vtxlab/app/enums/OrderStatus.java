...
enum OrderStatus {
  ...
  public static OrderStatus fromCode2(int code){  //OrderStatus.values() returns OrderStatus[]
    //stream
  ...
  public static Optional<OrderStatus> fromCode3(int code)  {  //OrderStatus.values() returns OrderStatus[]
    return Arrays.stream(OrderStatus.values())
                 .filter(e -> e.code == code)
